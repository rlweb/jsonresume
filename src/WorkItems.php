...
class WorkItems extends ClassStructure
{
    /** @var string e.g. Facebook */
    public $name;

    /** @var string e.g. Menlo Park, CA */
    public $location;

    /** @var string e.g. Social Media Company */
    public $description;
    ...
    /** @var string[]|array Specify multiple accomplishments */
    public $highlights;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $properties->name->description = "e.g. Facebook";
        $properties->location = Schema::string();
        $properties->location->description = "e.g. Menlo Park, CA";
        $properties->description = Schema::string();
        $properties->description->description = "e.g. Social Media Company";
        ...
        $properties->highlights->description = "Specify multiple accomplishments";
        $ownerSchema->type = 'object';
        $ownerSchema->additionalProperties = true;
    }

    /**
     * @param string $name e.g. Facebook
     * @return $this
    ...
    /**
     * @param string $location e.g. Menlo Park, CA
     * @return $this
     * @codeCoverageIgnoreStart
     */
    ...
    /**
     * @param string $description e.g. Social Media Company
     * @return $this
     * @codeCoverageIgnoreStart
     */
    ...
    /**
     * @param string[]|array $highlights Specify multiple accomplishments
     * @return $this
     * @codeCoverageIgnoreStart
     */
